...
const MOODS: Mood[] = [
  {
    ...
    dot: "#d4a96a",
    rainOn: false,
    // Source: deluxesalon.in "Saloon Classics" rotation — exact track list
  ...
  },
  {
    id: "shaadi",
    label: "Shaadi & Sunday",
    labelHindi: "शादी और इतवार",
    emoji: "🎉",
    desc: "Wedding-procession energy — the loud, happy side of the same decade",
    bg: "/image.webp",
    dot: "#f06030",
    rainOn: false,
    // Source: deluxesalon.in "Shaadi & Sunday" rotation — exact track list
  ...
  },
  {
    ...
    labelHindi: "फोकस",
    emoji: "💻",
    desc: "Steady instrumental-era Bollywood — good background for deep work sessions",
    bg: "/image2.webp",
    dot: "#3b9eff",
    rainOn: false,
